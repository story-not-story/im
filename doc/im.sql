...
CREATE TABLE `friend` (
  ...
  `u_remark` varchar(32) DEFAULT NULL COMMENT 'friend对user的备注',
  `f_remark` varchar(32) DEFAULT NULL COMMENT 'user对friend的备注',
  `u_label_id` int(10) unsigned DEFAULT NULL COMMENT 'friend对user的分组id(null默认我的好友)',
  `f_label_id` int(10) unsigned DEFAULT NULL COMMENT 'user对friend的分组id(null默认我的好友)',
...
CREATE TABLE `user` (
  ...
  `district_id` int(10) unsigned DEFAULT NULL COMMENT '区号',
