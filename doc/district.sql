...
CREATE TABLE `district` (
  ...
  `district_name` varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '城市的名字',
  `type` int(11) DEFAULT NULL COMMENT '城市的类型，0是国，1是省，2是市，3是区',
  `hierarchy` int(11) DEFAULT NULL COMMENT '地区所处的层级',
  `district_sqe` varchar(255) COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '层级序列',
  PRIMARY KEY (`id`)
