...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2).groupName("im-api")
                //加载配置信息
                .apiInfo(apiInfo())
                //设置全局参数
...
//                .securitySchemes(security());
    ...
    private ApiInfo apiInfo() {
        Contact contact = new Contact("hujun", "", "1209226858@qq.com");
        return new ApiInfoBuilder().title("接口文档").description("by B16041309胡君").contact(contact)
                .version("1.0.0").build();
    }
